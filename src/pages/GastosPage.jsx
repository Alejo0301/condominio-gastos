    ...
    <div className="px-4 py-6 lg:px-8 max-w-screen-xl mx-auto space-y-5">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="px-4 py-2.5 rounded-xl border border-surface-200 text-sm text-surface-700 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition"
        >
            ...
            <table className="w-full text-sm">
                      ...
                      <td className="px-3 py-3.5">
                        <div className="flex items-center gap-1 justify-end">
                          <button
                            ...
                            className="p-1.5 rounded-lg text-surface-400 hover:text-accent-600 hover:bg-accent-50 transition"
                            title="Editar"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <tfoot>
                <tr className="border-t border-surface-200 bg-surface-50">
                  <td colSpan={esAdmin ? 4 : 3} className="px-5 py-3 text-xs font-semibold text-surface-500 uppercase tracking-wider">
                    Total filtrado
                  </td>
              ...
              <div key={g.id} className="bg-white rounded-2xl border border-surface-100 shadow-card p-4">
                ...
                {esAdmin && (
                  <div className="flex gap-2 mt-3 pt-3 border-t border-surface-50">
                    <button
                      onClick={() => setEditando(g)}
                      className="flex-1 py-1.5 text-xs font-medium text-accent-600 bg-accent-50 rounded-lg hover:bg-accent-100 transition"
                    >
                      Editar
                    </button>
                    <button
                      onClick={() => handleEliminar(g.id)}
                      className="flex-1 py-1.5 text-xs font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition"
                    >
                      Eliminar
                    </button>
                  </div>
